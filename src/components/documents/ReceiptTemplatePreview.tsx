    ...
    >
      ...
      <div className={`flex items-start justify-between pb-4 mb-6 border-b-2`} style={{ borderColor: settings.border_color }}>
        ...
        <div className="text-right">
          <h2 className="text-xl font-bold mb-2" style={{ color: settings.header_color_primary }}>KWITANSI</h2>
      ...
      <div className="flex justify-between items-end mb-8">
        ...
        {/* Stamp placeholder */}
        <div className="w-24 h-24 border-2 border-dashed border-green-400 rounded-full flex items-center justify-center text-green-500 text-xs font-bold">
          LUNAS
        </div>
      </div>
