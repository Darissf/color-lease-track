            ...
            <div className="p-4 space-y-4">
              ...
              <Accordion type="multiple" defaultValue={['branding', 'colors']} className="space-y-3">
                ...
                <AccordionItem value="signature" className="border rounded-lg px-4">
                  ...
                  <AccordionContent className="pb-4"><SignatureSection settings={settings} updateSetting={updateSetting} onFileSelect={handleFileSelect} onRemoveImage={handleRemoveImage} uploading={uploading} layoutSettings={currentLayoutSettings} updateLayoutSetting={updateLayoutSetting} documentMode="invoice" /></AccordionContent>
                </AccordionItem>
