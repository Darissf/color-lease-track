...
import { Shield, ArrowLeft, MessageSquare, ChevronRight, FileText, Mail, BarChart3, Palette, LayoutDashboard, Edit3, Brain, Users, Link, Receipt, Banknote, Server, Database, RefreshCw } from "lucide-react";
    ...
    <div className="h-[calc(100vh-104px)] relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-6 lg:px-8 pb-4">
        ...
        <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card 
            className="p-3 sm:p-4 hover:shadow-lg transition-all cursor-pointer group border-2 hover:border-cyan-500"
            onClick={() => navigate("/vip/settings/backup")}
          >
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-cyan-600 flex items-center justify-center shrink-0">
                <Database className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-sm sm:text-base text-foreground group-hover:text-cyan-600 transition-colors truncate">
                  Backup & Restore
                </h3>
                <p className="text-xs text-muted-foreground truncate">
                  Export/import seluruh database (113 tabel)
                </p>
              </div>
              <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-cyan-600" />
            </div>
          </Card>

          <Card 
            className="p-3 sm:p-4 hover:shadow-lg transition-all cursor-pointer group border-2 hover:border-orange-500"
            onClick={() => navigate("/vip/settings/sync-contracts")}
          >
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-orange-600 flex items-center justify-center shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-sm sm:text-base text-foreground group-hover:text-orange-600 transition-colors truncate">
                  Sinkron Detail Kontrak
                </h3>
                <p className="text-xs text-muted-foreground truncate">
                  Update format rincian template massal
                </p>
              </div>
              <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-orange-600" />
            </div>
          </Card>
