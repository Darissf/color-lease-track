...
import { Shield, ArrowLeft, MessageSquare, ChevronRight, FileText, Mail, BarChart3, Palette, LayoutDashboard, Edit3, Brain, Users, Link, Receipt, Banknote, Server, Stamp } from "lucide-react";
    ...
    <div className="h-[calc(100vh-104px)] relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-6 lg:px-8 pb-4">
        ...
        <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-rose-600 flex items-center justify-center shrink-0">
                <Stamp className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-sm sm:text-base text-foreground group-hover:text-primary transition-colors truncate">
                  Custom Stempel
                ...
                <p className="text-xs text-muted-foreground truncate">
                  Kustomisasi stempel dokumen (font, tipe, posisi, warna)
                </p>
              </div>
              <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-primary" />
            </div>
