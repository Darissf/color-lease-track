    ...
    for (const mutation of mutations) {
      ...
      if (matchedRequest) {
        ...
        if (requestData?.rental_contracts) {
          ...
          console.log(`[Mutasibank Webhook] Payment recorded: fullAmount=${fullAmount}, transferred=${transferredAmount}, uniqueCode=${uniqueCode}, newTagihan=${newTagihanBelumBayar}`);
